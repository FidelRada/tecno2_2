    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-8">
        <form wire:submit="save">
            ...
            <div class="mb-4">
                ...
                <x-input class="w-full font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"
                    wire:model="postCreate.nrotarjetadecredito" />
                <x-input-error for="postCreate.nrotarjetadecredito" />
            </div>
        ...
        <x-dialog-modal wire:model="open">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-input class="w-full font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"
                        wire:model="postEdit.nrotarjetadecredito" />
                    <x-input-error for="postEdit.nrotarjetadecredito" />
                </div>
