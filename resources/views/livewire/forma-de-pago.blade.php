<div>
    @can('añadir un nuevo metodo de pago')
    ...
    @can('ver lista de metodos de pago')
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <ul class="list-disc list-inside space-y-2">
            @foreach ($formaDePagos as $categoria)
                <li class="font-semibold text-sm dark:text-gray-200 leading-tight mb-3 flex justify-between"
                    ...
                    <div>
                        @can('editar un metodo de pago')
                        <x-button wire:click="edit({{ $categoria->id }})">Editar</x-button>
                        @endcan
                        @can('eliminar un metodo de pago')
